...
CALIBRATION_PROFILES = {
    ...
    "rpnova": {
        "compatible": "retroidpocket,rpnova", "backend": "rsinput",
        "trigger_codes": {"left_trigger": (2, 10), "right_trigger": (5, 9)},
        "trigger_max": 1552, "minimum_trigger_fraction": 0.8, "calibrate_axes": False,
        "trigger_apply": False,
        "axis_range": 1024, "axis_deadzone": 0,
    ...
    "thor": {
        "compatible": "ayn,thor", "backend": "rsinput",
        "trigger_codes": {"left_trigger": (2, 10), "right_trigger": (5, 9)},
        "trigger_max": 1552, "minimum_trigger_fraction": 0.8, "calibrate_axes": False,
        "trigger_apply": False,
        "axis_range": 1408, "axis_deadzone": 70,
    },
    "retroid": {
...
def commit_mcu_calibration(token):
    return call("rsinput_calibration_commit", token=str(token))
