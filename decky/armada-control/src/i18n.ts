...
const zhCN = {
  ...
  "Steam chooses the compatibility tool for each game.": "由 Steam 为每个游戏选择兼容性工具。",
  "Reset Performance to Default": "将性能设置恢复为默认值",
  "All Cores": "全部核心",
  "Big Cores": "大核心",
  "Prime Cores": "超大核心",
  "Little Cores": "小核心",
  ...
  "PROFILE SETTINGS": "功耗方案设置",
  "GAME PROFILE SETTINGS": "游戏方案设置",
  "Fan Curve": "风扇曲线",
  ...
  "Sleep Mode": "休眠模式",
  "Bottom Screen": "下屏",
  "Run Plasma Mobile on the second display": "在第二块屏幕上运行 Plasma 移动版",
  "Bottom Screen Brightness": "下屏亮度",
  "Could not change bottom screen": "无法更改下屏设置",
  "Could not change bottom-screen brightness": "无法更改下屏亮度",
  "Desktop Mode": "桌面模式",
  ...
  "Press Start, then move sticks and triggers through full range.": "按下“开始校准”后，将两个摇杆沿边缘转动一圈，并将两个扳机按到底。",
  "Left Stick": "左摇杆",
  "Right Stick": "右摇杆",
  "Close": "关闭",
  ...
  "{tool} is no longer installed. Choose a new default for your games.": "{tool} 已被卸载。请为游戏选择新的默认工具。",
  ...
  "Stop Editing": "停止编辑",
  "FAN STOPPED": "风扇已停转",
  "D-Pad moves point {current} of {total} · LB/RB switches points · B stops": "方向键移动第 {current} 个节点（共 {total} 个） · LB/RB 切换节点 · B 停止编辑",
